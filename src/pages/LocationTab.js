  ...
  <div id="tab-panel-location" role="tabpanel">
    <div className="rounded-lg shadow bg-white p-8 text-center">
      ...
      <div className="flex justify-center my-6">
        <img
          src={`https://maps.googleapis.com/maps/api/staticmap?center=Burlington,ON,Canada&zoom=12&size=400x256&markers=color:red%7Clabel:B%7C43.3256,-79.7990&key=AIzaSyAv80U70-3sZ1aaJMHE672gp_cLfdqMRNE`}
